...
<https://canvasui.dev/docs/components/dithered-object>

## Install

```sh
npx shadcn@latest add @canvas-ui/dithered-object-react
```
...
| Property             | Type                     | Default                                                     | Description                                                                                                                                                                                                                                                                                            | <br />  | <br />                                                                                              |
| :------------------- | :----------------------- | :---------------------------------------------------------- | :----------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- | :------ | :-------------------------------------------------------------------------------------------------- |
| src                  | string                   | <br />                                                      | URL of the asset to display: GLB/glTF, SVG, PNG, JPEG, WebP, or GIF. Object URLs from a file input work too. The format is sniffed from the bytes, not the extension. Draco-compressed models are supported via a decoder fetched on demand, and flat art is mounted as a card lit by the same studio. | <br />  | <br />                                                                                              |
| method               | "bayer"                  | "halftone"                                                  | "floyd"                                                                                                                                                                                                                                                                                                | "bayer" | Dither pattern: an ordered Bayer grid, clustered halftone dots, or Floyd–Steinberg error diffusion. |
| gridSize             | number                   | 4                                                           | Size of the dither cells in CSS pixels.                                                                                                                                                                                                                                                                | <br />  | <br />                                                                                              |
| pixelSizeRatio       | number                   | 1                                                           | Extra pixelation applied on top of the grid size (1 to 10).                                                                                                                                                                                                                                            | <br />  | <br />                                                                                              |
| grayscale            | boolean                  | true                                                        | Collapse the scene to grayscale before dithering.                                                                                                                                                                                                                                                      | <br />  | <br />                                                                                              |
| invert               | boolean                  | false                                                       | Invert the final colors.                                                                                                                                                                                                                                                                               | <br />  | <br />                                                                                              |
| dither               | boolean                  | true                                                        | Enable the dither pass. Turn off to see the raw render.                                                                                                                                                                                                                                                | <br />  | <br />                                                                                              |
| background           | string                   | "" (transparent)                                            | Background color behind the object. Leave empty for a transparent canvas.                                                                                                                                                                                                                              | <br />  | <br />                                                                                              |
| highlight            | string                   | "#066aff"                                                   | Accent color of the ring light in the studio environment.                                                                                                                                                                                                                                              | <br />  | <br />                                                                                              |
| environmentIntensity | number                   | 0.1                                                         | Brightness of the studio environment lighting.                                                                                                                                                                                                                                                         | <br />  | <br />                                                                                              |
| roughness            | number                   | -1                                                          | Roughness override applied to every material (0 to 1). Negative keeps the asset's own values.                                                                                                                                                                                                          | <br />  | <br />                                                                                              |
| scale                | number                   | 3                                                           | Size of the longest side of the object in scene units. The camera sits about 4 units away.                                                                                                                                                                                                             | <br />  | <br />                                                                                              |
| xOffset              | number                   | 0                                                           | Horizontal offset of the object in scene units.                                                                                                                                                                                                                                                        | <br />  | <br />                                                                                              |
| yOffset              | number                   | 0                                                           | Vertical offset of the object in scene units.                                                                                                                                                                                                                                                          | <br />  | <br />                                                                                              |
| floatIntensity       | number                   | 2                                                           | Strength of the floating bob animation (0 disables).                                                                                                                                                                                                                                                   | <br />  | <br />                                                                                              |
| rotationIntensity    | number                   | 1                                                           | Strength of the idle rocking rotation (0 disables).                                                                                                                                                                                                                                                    | <br />  | <br />                                                                                              |
| floatSpeed           | number                   | 2                                                           | Speed of the float and rocking animation.                                                                                                                                                                                                                                                              | <br />  | <br />                                                                                              |
| orbit                | boolean                  | true                                                        | Let the user orbit the camera by dragging.                                                                                                                                                                                                                                                             | <br />  | <br />                                                                                              |
| zoom                 | boolean                  | false                                                       | Let the user zoom with the scroll wheel or pinch.                                                                                                                                                                                                                                                      | <br />  | <br />                                                                                              |
| autoRotate           | boolean                  | false                                                       | Spin the camera around the object turntable-style.                                                                                                                                                                                                                                                     | <br />  | <br />                                                                                              |
| autoRotateSpeed      | number                   | 2                                                           | Turntable speed when autoRotate is on.                                                                                                                                                                                                                                                                 | <br />  | <br />                                                                                              |
| fov                  | number                   | 65                                                          | Camera field of view in degrees.                                                                                                                                                                                                                                                                       | <br />  | <br />                                                                                              |
| cameraDistance       | number                   | 4.2                                                         | Camera distance from the center of the object.                                                                                                                                                                                                                                                         | <br />  | <br />                                                                                              |
| dracoDecoderPath     | string                   | "<https://www.gstatic.com/draco/versioned/decoders/1.5.7/>" | Base URL of the Draco decoder, fetched only when a model needs it.                                                                                                                                                                                                                                     | <br />  | <br />                                                                                              |
| onLoad               | () => void               | <br />                                                      | Called after an asset finishes loading.                                                                                                                                                                                                                                                                | <br />  | <br />                                                                                              |
| onError              | (error: unknown) => void | <br />                                                      | Called when an asset fails to load.                                                                                                                                                                                                                                                                    | <br />  | <br />                                                                                              |
| className            | string                   | <br />                                                      | Classes applied to the wrapper element.                                                                                                                                                                                                                                                                | <br />  | <br />                                                                                              |
